...
primitiveMisc = ("Primitive Misc.", [(["()"],[SExp []],"[nil]"),(["eq?"],[SymExp "eq?"],"[*primitive*]"),(["(+)","(-)","(*)","(>)","(<)","(>=)","(<=)","(=)","(!=)","(eq?)","(and)","(or)","(not)","(list)","(car)","(cdr)"],[SExp [SymExp "+"],SExp [SymExp "-"],SExp [SymExp "*"],SExp [SymExp ">"],SExp [SymExp "<"],SExp [SymExp ">="],SExp [SymExp "<="],SExp [SymExp "="],SExp [SymExp "!="],SExp [SymExp "eq?"],SExp [SymExp "and"],SExp [SymExp "or"],SExp [SymExp "not"],SExp [SymExp "list"],SExp [SymExp "car"],SExp [SymExp "cdr"]],"[0,0,1,t,t,t,t,t,t,t,t,nil,*** Scheme-Exception: `not` is a unary operator. ***,nil,*** Scheme-Exception: `car` is a unary operator. ***,*** Scheme-Exception: `cdr` is a unary operator. ***]"),(["(eq? 5 5)","(eq? 6 5 6)","(eq? (+ 3 3) 6)","(eq? 'a 5)","(eq? 'a 'b)","(eq? 'a 'a 'b)","(eq? 'a 'a 'a)"],[SExp [SymExp "eq?",IntExp 5,IntExp 5],SExp [SymExp "eq?",IntExp 6,IntExp 5,IntExp 6],SExp [SymExp "eq?",SExp [SymExp "+",IntExp 3,IntExp 3],IntExp 6],SExp [SymExp "eq?",SExp [SymExp "quote",SymExp "a"],IntExp 5],SExp [SymExp "eq?",SExp [SymExp "quote",SymExp "a"],SExp [SymExp "quote",SymExp "b"]],SExp [SymExp "eq?",SExp [SymExp "quote",SymExp "a"],SExp [SymExp "quote",SymExp "a"],SExp [SymExp "quote",SymExp "b"]],SExp [SymExp "eq?",SExp [SymExp "quote",SymExp "a"],SExp [SymExp "quote",SymExp "a"],SExp [SymExp "quote",SymExp "a"]]],"[t,nil,t,nil,nil,nil,t]")],["Do you handle the empty form `()` correctly?","Do you handle the base-cases of the primitive operators correctly?","Do you handle `eq?` correctly?"])
